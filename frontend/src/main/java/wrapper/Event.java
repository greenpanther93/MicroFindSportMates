...
public class Event implements IEvent , Proxy {
    ...
    public void setParticipants(Set<IUser> participants) {
        ...
        for (IUser participants_element : ((Iterable<IUser>)participants)) {
            param_node_list.add(((Proxy)participants_element).getProxyId());
        }
    ...
    public Set<IUser> getParticipants() {
        ...
        Set<IUser> return_set = new HashSet();
        ...
        while (return_set_iterator.hasNext()) {
            ...
            IUser return_set_element = new User(return_set_node.asInt());
